...
Prints a short summary of any given content types within tree structure by listing the number of files that match your search for each directory. The script will sort results by size of requested data in reverse order.
