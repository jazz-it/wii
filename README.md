# wii
**What's In It?** - Measure disk usage by filtering specific file type(s) only
...
**IMPORTANT**: The script does not use POSIX [find](http://pubs.opengroup.org/onlinepubs/9699919799/utilities/find.html), but GNU [find](http://www.gnu.org/software/findutils/manual/html_mono/find.html#Print-File-Information)!
